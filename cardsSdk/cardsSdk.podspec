Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/cardsSdk.framework') || Dir.empty?('build/cocoapods/framework/cardsSdk.framework')
        ...
        Kotlin framework 'cardsSdk' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :cardsSdk:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':cardsSdk',
        'PRODUCT_MODULE_NAME' => 'cardsSdk',
    }
